<template>
      ...
      <img src="/public/bizarrecraft2.png" width="500">
        <br><br>
        <p>Vanilla+ модовый сервер с ламповым комьюнити. Это пространство для воплощения всех твоих идей и проектов! </p>
        ...
        <p style="font-size: smaller; padding-top: 10px;">Для игры нужен Fabric 1.21.4</p>
